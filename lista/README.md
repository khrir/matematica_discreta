## Questões da lista de matemática discreta
...
10. Generakkkkklize o programa da questão anterior para funcionar com n congruências ao invés de somente 3, onde n será dado pelo usuário.
